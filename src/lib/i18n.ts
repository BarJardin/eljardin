...
export const translations: Record<LanguageCode, TranslationMessages> = {
  es: {
    ...
    menuItemsTitle: "Platos de esta categoria",
    categoryEmpty: "Todavia no hay platos activos en esta categoria.",
    visitUs: "Ven a visitarnos",
    reserveTable: "Reservar Mesa",
    reservationText: "Reserva tu mesa por telefono o WhatsApp y disfruta de la mejor cocina tradicional.",
    callNow: "Llamar ahora",
    findUsKicker: "Encuentranos",
